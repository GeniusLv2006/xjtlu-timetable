...
<template>
  <div class="terms-page">
    ...
    <div class="terms-body">
      ...
      <h2>三、数据收集与隐私保护</h2>
      <p>透明度是我们重视的核心原则。本章节详述本服务收集的所有数据类型、用途及保留期限，不存在任何隐性数据采集行为。</p>
      ...
      <table class="data-table">
        ...
        <tbody>
          ...
          <tr>
            <td>课表数据（课程代码、时间、地点、教师等）及内容哈希（同步去重校验值）</td>
            <td>展示与好友对比功能</td>
            <td>服务器数据库</td>
          </tr>
          <tr>
      ...
      <p>出于安全审计目的，访问日志和登录日志将于 <strong>30 天内自动清除</strong>。该类日志不含课表内容，仅含时间戳、脱敏 IP 段、国家/地区、城市及设备信息（仅管理员可查）。</p>
      <p>如遇技术问题无法自助删除，请通过本协议末尾联系方式告知，我们将在 <strong>7 个工作日</strong>内完成处理。</p>
      ...
      <h2>五、知识产权</h2>
      <p>本服务的源代码、界面设计及相关内容著作权归开发者所有，未经授权不得复制、仿制或用于商业用途。您上传的课表数据著作权归您本人所有；本服务仅在提供功能所必需的范围内存储和处理上述数据，不主张超出此范围的任何权利。</p>
