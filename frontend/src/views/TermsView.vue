...
<template>
  <div class="terms-page">
    ...
    <div class="terms-body">
      ...
      <h2>五、知识产权</h2>
      <p>本服务源代码以 <strong>GNU AGPL v3</strong> 协议开源，允许在遵循该协议条款的前提下自由使用与修改；界面设计、视觉元素及其他非代码内容的著作权归开发者所有，未经授权不得用于商业用途。您上传的课表数据著作权归您本人所有；本服务仅在提供功能所必需的范围内存储和处理上述数据，不主张超出此范围的任何权利。</p>
